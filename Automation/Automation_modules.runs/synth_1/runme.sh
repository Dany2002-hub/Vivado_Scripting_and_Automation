...
HD_PWD='/home/vlsidesign9/Work/Daniel/ICDesignLab_4/VIVADO/Automation/Automation_modules.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_PE_behav.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_PE_behav.tcl
