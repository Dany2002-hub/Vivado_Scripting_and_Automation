...
HD_PWD='/home/vlsidesign9/Work/Daniel/ICDesignLab_4/VIVADO/Automation/Automation_modules.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_PE_behav.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_PE_behav.tcl -notrace
